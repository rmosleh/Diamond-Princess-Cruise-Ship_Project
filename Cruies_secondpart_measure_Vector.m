function dIdt=Cruies_secondpart_measure_Vector(t,I, param)
...
l2=beta2*(B1./(1+c2*B1));
      ...
      dIdt(1:5:5*n)=[nu2 0;0 nu1]*flip(I(1:5:5*n))-w2*I(1:5:5*n)-(mm*L2+(1-mm)*l2).*I(1:5:5*n)-[nu1 0;0 nu2]*I(1:5:5*n);
dIdt(2:5:5*n)=[nu2 0;0 nu1]*flip(I(2:5:5*n))+(mm*L2+(1-mm)*l2).*I(1:5:5*n)-epsilon0*I(2:5:5*n)-[nu1 0;0 nu2]*I(2:5:5*n);
