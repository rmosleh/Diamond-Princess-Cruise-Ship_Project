function dIdt=Cruies_isolationcluster_Vector(t,I,p)

% This function solves the system for the second part of the voayge without
...
%--------------- System for the second part of the voyage
